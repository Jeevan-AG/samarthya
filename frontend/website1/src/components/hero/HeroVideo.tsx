    ...
    >
      ...
      >
        <Image
          ...
          unoptimized
          sizes="100vw"
          className="object-contain lg:object-cover object-center pointer-events-none select-none"
        />
      </div>
      ...
      {!prefersReducedMotion && !videoError && (
        <video
          ...
          onContextMenu={(e) => e.preventDefault()}
          className={`absolute inset-0 w-full h-full object-contain lg:object-cover object-center pointer-events-none transition-opacity duration-1000 z-10 ${
